namespace Labb4_Generic_Collection
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            MenuItem Hotdog = new MenuItem(1, "Hotdog", 99M);
            MenuItem Pizza = new MenuItem(2, "Pizza", 150M);
            MenuItem Hamburger = new MenuItem(3, "Hamburger", 180M);
            MenuItem Kebab = new MenuItem(4, "Kebab", 199M);
            MenuItem Falafel = new MenuItem(5, "Falafel", 200M);
